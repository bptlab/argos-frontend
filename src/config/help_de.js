const help_de = {
	...
	input: {
		...
		columnNameSearchValue: "Spaltenname: Suchbegriff",
	},
	button: {
	...
	descriptions: {
		...
		queryInputFieldHint: "Esper EPL Abfrage",
		queryDescriptionInputFieldHint: 'Beschreibung für Abfrage',
